...
*1 – неподвижная камера; 2 – подвижная камера; 3 – 3-х координатный позиционер; 4 – штатив для камер; 5 – объект измерения; 6 – лазерная измерительная установка; <br> 7 – 2-х координатный позиционер лазера; 8 – сервоприводы для деформации поверхности объекта; 9 – дополнительное освещение*
